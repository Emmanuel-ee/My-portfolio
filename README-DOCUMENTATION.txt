For your personal projects you can generate the image you want using midjourney and 
replace it with the placeholder image. The steps to generate such image is 
shown in the prompt given in the public folder via prompts.txt file.
